    ...
    return (
        <div className=" text-white px-4">
            ...
            <section className="pt-8 sm:flex gap-4 items-center justify-center">
                <div className="container mx-auto">
                    ...
                    >
                        <motion.span
                            ...
                            className="block"
                        >
                            Hi, I'm <span className="text-[#804dee]">Md. Atiqul Islam Rajib</span>
                        </motion.span>
                    </motion.h1>
                    <motion.h3
                        initial={{ opacity: 0, y: 20 }}
                ...
                >
                    <motion.img
                        className='max-w-xl h-96 rounded-full'
                        src={img}
                        alt=""
            ...
            <motion.div 
             ...
             transition={{ duration: 0.8, delay: 0.8 }}className='my-8 flex gap-8'>
                <a href="https://www.facebook.com/atikul.rajib" className="relative inline-flex items-center justify-center btn btn-outline btn-circle border-[#804dee] overflow-hidden font-mono font-medium tracking-tighter text-[#804dee] bt group">
                ...
                <a href="https://github.com/Rajib-10" className="relative inline-flex items-center justify-center btn btn-outline btn-circle border-[#804dee] overflow-hidden font-mono font-medium tracking-tighter text-[#804dee] bt group">
                    <span className="absolute w-0 h-0 transition-all duration-500 ease-out bg-[#804dee] rounded-full group-hover:w-56 group-hover:h-56"></span>
                    <span className="absolute inset-0 w-full h-full -mt-1 rounded-lg opacity-30 bg-gradient-to-b from-transparent via-transparent"></span>
                    <span className="relative"><FaGithub></FaGithub></span>
                </a>
                <a href="https://www.linkedin.com/in/md-atiqul-islam-rajib-013a92298/" className="relative inline-flex items-center justify-center btn btn-outline btn-circle border-[#804dee] overflow-hidden font-mono font-medium tracking-tighter text-[#804dee] bt group">
                    <span className="absolute w-0 h-0 transition-all duration-500 ease-out bg-[#804dee] rounded-full group-hover:w-56 group-hover:h-56"></span>
                    <span className="absolute inset-0 w-full h-full -mt-1 rounded-lg opacity-30 bg-gradient-to-b from-transparent via-transparent"></span>
